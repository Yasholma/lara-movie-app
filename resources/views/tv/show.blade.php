...
@section('content')
<div class="tv-info border-b border-gray-800" x-data="{isOpen: false}">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{  $tv['poster_path'] }}" class="w-64 lg:w-96" alt="{{ $tv['name'] }}">
        </div>

        <div class="md:ml-24">
            <h2 class="text-2xl md:text-4xl font-semibold">{{ $tv['name'] }}</h2>
            ...
            <div class="mt-12">
                <button @click="isOpen = true"
                    class="flex w-40 items-center bg-orange-500 text-gray-900 font-semibold rounded py-4 px-5 hover:bg-orange-500 transition ease-in-out duration-300">
    ...
    <div class="tv-cast border-b border-gray-800">
        ...
        <div class="tv-cast border-b border-gray-800" x-data="{isOpen: false, image: ''}">
            <div class="container mx-auto px-4 py-16">
