...
<div class="movie-info border-b border-gray-800">
    <div class=" container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ $actor['profile_path'] }}" class="w-64 lg:w-96" alt="actor">
        ...
        <div class="md:ml-24">
            ...
            <div class="flex flex-wrap items-center text-gray-300 text-sm">
                ...
                <span class="ml-2">{{ $actor['birthday'] }} ({{ $actor['age'] }}) in {{ $actor['pob'] }}</span>
            ...
            <h4>
                <font-semibold class="mt-12">Known For</font-semibold>
